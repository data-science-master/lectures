...
- Alternative method:
    - [Setting up a GitHub Pages site with Jekyll](https://docs.github.com/en/free-pro-team@latest/github/working-with-github-pages/setting-up-a-github-pages-site-with-jekyll) (this is what I use for my personal website).
...
- Netlify should give you an automatically generated URL where you website is deployed. E.g. mine is deployed to <>
