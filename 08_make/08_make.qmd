...
- Each subsequent line is a *bash* command that will be evaluated in the terminal in the order listed. This sequence of commands is sometimes called a *recipe*.
  ...
  - From the terminal, it is possible to evaluate R scripts, python scripts, and render Quarto files.
...
- tl;dr
  ...
  - For Quarto and R Markdown: Assume the working directory is the location of the Rmd file.
...
-   However, confusingly, when you render a Quarto or R Markdown file, you need to assume the working directory is the location of the R Markdown file, not the location of `Makefile`. So in "report.Rmd" you would write (**notice the double dots**)
