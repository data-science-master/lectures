...
- In SQL, you mutate variables while you SELECT. You use `AS` to specify what the new variable is called.
...
- Let's create the tables we will need. Note that I am putting a semicolon "`;`" after each SQL call in the same code chunk.
    ...
    INSERT INTO table4a (country, y1999, y2000) 
        VALUES
    ...
    INSERT INTO table2 (country, year, vtype, casecount)
        VALUES
...
- You typically should be explicit about executing the query by using `collect()` at the end.
...
- After you are donw with SQL, you should close down your connection:
