...
These are trying times, and so attending lectures will be voluntary. I still expect you to learn the material. There is a participation portion for the class grade. If you cannot attend lectures, you can fulfill the participation requirement by posting comments/questions on GitHub, or answering other students' questions on GitHub.

During exercises and labs, I will split the class up into breakout sessions of 2-4 students. One student should share their screen and the other students can discuss and type suggestions while the group solves the exercise. One group will be chosen to present their results to the class.
