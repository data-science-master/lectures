...
- We will have four closed book, closed computer, closed notes, closed calculator quizzes for a total of 40% of the grade (10% each).
...
- Final Project: 25%
- Tidyverse Quiz: 10%
- Git/Vectors/Iteration/Dates Quiz: 10%
- SQL Quiz: 10%
- Python Quiz: 10%
