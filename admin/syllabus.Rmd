...
- If you use generative AI **you must include an appendix with your prompts and resulting output**.
...
- If you use generative AI, then **failure to include a generative AI appendix will be considered a violation of the academic integrity code.**
