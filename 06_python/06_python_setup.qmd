...
-   You might need to accept the conda [terms of service](https://www.anaconda.com/legal/terms/terms-of-service) to use conda. So run the following code to load `reticulate`.
