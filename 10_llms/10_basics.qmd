...
-   Windows Users: Use the [PowerShell](https://en.wikipedia.org/wiki/PowerShell) (**not** git bash for windows) and run
...
-   Let's see the embeddings for some tokens. 
    - Don't worry about the exact code. Folks don't do this so it's a little wonky.
    ```{python}
