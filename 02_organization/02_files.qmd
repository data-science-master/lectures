...
- Note that Mac (and other Linux varieties) uses forward slashes, while Windows uses back slashes. This is not something you have to worry about most of the time (e.g., Git Bash for Windows uses forward slashes), but it's something to be aware of.
...
- When naming files or folders, **do not use periods**.
  - These should be reserved for file extensions.
  
- When naming files or folders, **do not depend on case** to differentiate files.
