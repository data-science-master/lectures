...
- So if your file structure is
    ...
    data/data.csv : analysis/script.R
        cd analysis; R CMD BATCH script.R
    ```
...
- If you do not like writing `R CMD BATCH` each time, then you can save this command as a variable. The two rules are equivalent:
...
- *Example*: Suppose I have the following rule:
    ...
    output/figs/foo.pdf : analysis/scripts/gaa.R data/hii.csv
        R CMD BATCH analysis/scripts/gaa.R
    ```
