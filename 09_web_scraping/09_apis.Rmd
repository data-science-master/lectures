...
- API: Application Programming Interface
    ...
    - Think of it like a webpage for a program. You click a button and expect 
      the website to do something. An API let's a program click a metaphorical 
...
- Each package will be entirely unique, and you have to read its documentation
  to know how to download data. So we won't covery any of them.
...
- It is important to never save or display your private key in a file you could share. 
  ...
  why we saved it to our .Renviron and am only accessing it secretly through
  `Sys.getenv()`.
...
- It is still not great that your key is in a plain text environment. You
  can add a layer of security by using the keyring package: <https://github.com/r-lib/keyring>
    ...
    key in a plain text file (which is what .Renviron is).
  
## httr

- Most API's on the web use HTTP (Hyper-Text Transfer Protocol).
