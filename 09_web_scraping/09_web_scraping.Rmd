...
- Suppose we wanted to get the top 100 movies of all time from IMDB. The
  web page is very unstructured:
    ...
    If the above link fails, try: <https://data-science-master.github.io/lectures/09_web_scraping/imdb_100.html>
    ```
...
- The Wikipedia article on hurricanes: <https://en.wikipedia.org/wiki/Atlantic_hurricane_season>
    ...
    ```{block, eval = FALSE, echo = FALSE}
    If the above link fails, try: <https://data-science-master.github.io/lectures/09_web_scraping/wiki.html>
    ```
...
- **Exercise**: The Wikipedia page on the oldest mosques in the world
  has many tables. 
    ...
    ```{block, eval = FALSE, echo = FALSE}
    If the above link fails, try: <https://data-science-master.github.io/lectures/09_web_scraping/mosque.html>
    ```
