...
- Chapter 25 of [RDS](https://r4ds.hadley.nz/)
...
- Note: Web scraping can be illegal in some circumstances, particularly if you intend to make money off of it or if you are collecting personal information. **I don't give legal advice**, so see Chapter 25 of [RDS](https://r4ds.hadley.nz/) for some general recommendations, and talk to a lawyer if you are not sure.
